...
if __name__ == '__main__':
    app.config.update(
        TWEETS_DATA="http://backend:5000/tweetsData",
        TOTAL_TWEETS="http://backend:5000/totalTweets",
        GREV = "http://backend:5000/grev",
        USER_METRICS = "http://backend:5000/userMetrics",
        POLARITY = "http://backend:5000/polarity",
        TWEETS = "http://backend:5000/tweets",
        METRICS = "http://backend:5000/metrics",
        CHAT = "http://backend:5000/chat",
        POS = "http://backend:5000/posCount",
        NEG = "http://backend:5000/negCount"
    )
